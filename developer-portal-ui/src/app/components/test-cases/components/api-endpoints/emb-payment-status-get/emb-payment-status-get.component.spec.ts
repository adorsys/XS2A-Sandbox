...
import { EmbPaymentStatusGetComponent } from './emb-payment-status-get.component';
import { LineCommandComponent } from '../../../../common/line-command/line-command.component';

describe('RdctPaymentStatusGetComponent', () => {
  let component: EmbPaymentStatusGetComponent;
  let fixture: ComponentFixture<EmbPaymentStatusGetComponent>;
  ...
  beforeEach(
    waitForAsync(() => {
      TestBed.configureTestingModule({
        declarations: [EmbPaymentStatusGetComponent, MockPlayWithDataComponent, TranslatePipe, LineCommandComponent],
      }).compileComponents();
    })
  );

  beforeEach(() => {
    fixture = TestBed.createComponent(EmbPaymentStatusGetComponent);
