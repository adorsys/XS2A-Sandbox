...
import { EmbPaymentInitPutTanComponent } from './emb-payment-init-put-tan.component';
...
describe('EmbPaymentInitPutComponent', () => {
  let component: EmbPaymentInitPutTanComponent;
  let fixture: ComponentFixture<EmbPaymentInitPutTanComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EmbPaymentInitPutTanComponent);
