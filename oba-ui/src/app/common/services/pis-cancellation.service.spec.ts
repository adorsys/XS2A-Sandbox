...
describe('PisCancellationService', () => {
  ...
  it('should call the cancellationService', () => {
    const service: PisCancellationService = TestBed.get(PisCancellationService);
    const pisCancellationService = TestBed.get(PSUPISCancellationProvidesAccessToOnlineBankingPaymentFunctionalityService);
  ...
  it('should call the selectScaMethod', () => {
    ...
    const selectMethodSpy = spyOn(pisCancellationService, 'selectMethodUsingPOST1');
