...
. Open postman, import following data  link:postman_collection_oauth2_prestep.json[oAuth Collection] and link:postman_environment_dev.json[environment] from our postman-scripts. Then, switch environment to `Xs2a DEV ENV`.
