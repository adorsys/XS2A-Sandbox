...
@FeignClient(value = "cmsPsuPiisClient", url = "${cms.url}", primary = false, configuration = FeignConfig.class)
public interface CmsPsuPiisV2Client extends CmsPsuConfirmationOfFundsApi {
}
