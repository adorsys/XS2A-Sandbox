...
public interface ConsentReferencePolicy {
	 ...
	 * @return a holder of the consent references
	 * @throws AuthorizationException the consent is not found of the scaId does not match the consent cookie.
	 */
	ConsentReference fromRequest(String encryptedConsentId, String authorizationId, String cookieString, boolean strict) throws AuthorizationException;
}
