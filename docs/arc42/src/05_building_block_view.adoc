...
image::../images/writebox.png[Whitebox Overall System Level 1, 60%, title="Whitebox Overall System Level 1", align="center"]
...
.whitebox-xs2a-lvl2
image::../images/generated/whitebox-2-xs2a.png[Whitebox xs2a Level 2, 60%, title="Whitebox xs2a Level 2", align="center"]
