...
export class RegisterComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.lastVisitedPage = this.pageNavigationService.getLastVisitedPage();
  }
  ...
  selectCountry() {
    ...
    this.service
      .getTppIdStructure(this.selectedCountry)
  ...
  onSubmit(): void {
    ...
    let message: string;
    const navigateUrl = '/management';
    const messageBeginning = 'New TPP has ';
